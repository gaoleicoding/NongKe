package com.nongke.thirdframe.retrofit;


import com.franmontiel.persistentcookiejar.PersistentCookieJar;
import com.franmontiel.persistentcookiejar.cache.SetCookieCache;
import com.franmontiel.persistentcookiejar.persistence.SharedPrefsCookiePersistor;
import com.nongke.base.api.ApiService;
import com.nongke.base.application.CustomApplication;
import com.nongke.thirdframe.retrofit.interceptor.GzipRequestInterceptor;
import com.nongke.thirdframe.retrofit.interceptor.HttpLoggingInterceptor;
import com.nongke.thirdframe.retrofit.interceptor.OfflineCacheInterceptor;
import com.nongke.thirdframe.retrofit.interceptor.OnlineCacheInterceptor;
import com.nongke.thirdframe.retrofit.interceptor.RetryIntercepter;
...
.cookieJar(new PersistentCookieJar(new SetCookieCache(), new SharedPrefsCookiePersistor(CustomApplication.context)))
        ...
        if (mRetrofit == null) {
            mRetrofit = new Retrofit.Builder()
                    ...
                    .baseUrl(com.nongke.thirdframe.retrofit.UrlConfig.BASE_URL)
